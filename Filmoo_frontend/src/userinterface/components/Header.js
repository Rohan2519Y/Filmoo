...
export default function Header() {
    ...
    return (<>
        <div className="bg-gray-500 border-b border-[#333333] shadow-xl  md:h-[100px] h-[80px] w-full flex">
            ...
            {menu &&
                <div className='bg-black opacity-[60%] fixed z-10 h-full w-full flex justify-center '>
                    <CloseIcon onClick={() => { setMenu(false) }} style={{ fontSize: '200%' }} className='text-white absolute right-5 top-4 cursor-pointer' />
