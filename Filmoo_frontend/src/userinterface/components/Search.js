    ...
    return (<>
        <div className="w-full h-[60px] bg-slate-900/80 flex justify-center items-center">
            <div className="w-[98%] mid:w-[1280px] h-[80%] bg-gray-600 flex justify-center items-center rounded-lg">
                <input type="text" placeholder="Search" className="md:w-[90%] w-[80%] h-[90%] bg-transparent text-center font-semibold text-white placeholder:text-center placeholder:text-gray-400 rounded-l-lg placeholder:text-xl"></input>
